    ...
    
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Price,Description,ImageUrl,ProductTypeID")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Price,Description,ImageUrl,ProductTypeID")] Product product)
        {
            if (ModelState.IsValid)
            {
